...
cout<<"\nEnter student's roll number [Roll number must contain only numbers] : ";
system("color E4");
	
cin>>rollno;

cout<<"\n\nEnter student name [Name should contain alphabets only] : ";
cin.ignore();
...
cout<<"\n Attendance of student is :"<<attendance;
...
cout<<"\n\nSorry!! You have not cleared this examination";
}
...
int main()
{
	...
	while (loginAttempt < 5)
    {
        ...
        if (userName == "simran" && userPassword == "tiger")
        {
            cout << "Welcome simran!\n";
            break;
        }
        else if (userName == "vaishnavi" && userPassword == "lion")
        {
            cout << "Welcome vaishnavi!\n";
            break;
        }
        else
        {
